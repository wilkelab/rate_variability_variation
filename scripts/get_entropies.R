...
write.csv(out_HP_data, "../data_summaries/virus_dataset/mapped_entropies/1RD8_AB_entropies.csv")
...
write.csv(out_WNPB_data, "../data_summaries/virus_dataset/mapped_entropies/2FP7_B_entropies.csv")
...
write.csv(out_CCHFN_data, "../data_summaries/virus_dataset/mapped_entropies/4AQF_B_entropies.csv")
...
write.csv(out_DPH_data, "../data_summaries/virus_dataset/mapped_entropies/2JLY_A_entropies.csv")
...
write.csv(out_HCP_data, "../data_summaries/virus_dataset/mapped_entropies/3GOL_A_entropies.csv")
...
write.csv(out_INP_data, "../data_summaries/virus_dataset/mapped_entropies/4IRY_A_entropies.csv")
...
write.csv(out_JEHN_data, "../data_summaries/virus_dataset/mapped_entropies/2Z83_A_entropies.csv")
...
write.csv(out_MRNABD_data, "../data_summaries/virus_dataset/mapped_entropies/4GHA_A_entropies.csv")
...
write.csv(out_RVFVNP_data, "../data_summaries/virus_dataset/mapped_entropies/3LYF_A_entropies.csv")
